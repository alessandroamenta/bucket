...
const bucketListItems: BucketListItem[] = [
  ...
  { id: 57, text: "ride in a self-driving car", completed: false },
  ...
  { id: 69, text: "see Jungle and Still Woozy live with my best friend", completed: false },
